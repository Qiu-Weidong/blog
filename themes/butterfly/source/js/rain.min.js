(function() {
    ...
    // 获取相关参数
    const rain_bg = document.currentScript.getAttribute("rain-bg-url") || "img/weather/texture-rain-bg.png";
    const storm_bg = document.currentScript.getAttribute("storm-bg-url") || "img/weather/texture-rain-bg.png";
    const fallout_bg = document.currentScript.getAttribute("fallout-bg-url") || "img/weather/texture-rain-bg.png";
    const sun_bg = document.currentScript.getAttribute("sun-bg-url") || "img/weather/texture-rain-bg.png";
    const drizzle_bg = document.currentScript.getAttribute("drizzle-bg-url") || "img/weather/texture-rain-bg.png";
